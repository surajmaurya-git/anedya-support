...
API_KEY = "c162871863193d4e0be89b6d680e11cc6f145bf0f84b2037287501b099e16ab4"
stream_variable_list=["temperature", "humidity", "pressure"]
...
def create_node():
    ...
    url = "https://stageapi.anedya.io/v1/node/create"
    payload = {
    ...
    info = resp.json()
    print("Created node:", json.dumps(info))
    NODE_ID = info.get("nodeId", "")

    # Get node info
    url = "https://stageapi.anedya.io/v1/node/details"
...
def create_stream():
    ...
    # stream_url = info["streamURL"] //for production
    stream_url = "wss://ZxBpErVPCj.acs-r1.ap-in-1.anedya.io:10443/v1/streams/connect" # for staging



def create_access_token():
    global token_id, token
    url = "https://stageapi.anedya.io/v1/access/tokens/create"
...
def set_key():
    url = "https://device.stageapi.anedya.io/v1/valuestore/setValue"
    payload = {
        "reqId": "",
        "key": "nodeKey1",
